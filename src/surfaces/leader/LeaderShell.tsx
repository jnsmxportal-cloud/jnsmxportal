  ...
  return (
    <div className="flex h-full min-h-0 bg-canvas">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <div className="flex flex-none flex-wrap items-center justify-between gap-y-2 border-b border-line bg-white px-4 py-2.5 lg:h-16 lg:px-6 lg:py-0">
          <div className="min-w-0">
            <h1 className="truncate text-base font-bold lg:text-[19px]">
